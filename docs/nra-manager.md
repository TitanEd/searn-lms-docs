...
**Goal:** Put the right training in a team member's queue.
...
**Goal:** Read learner feedback on trainings.

**Navigation:** Left Navigation → NRA-Specific Training Catalogue

- Click **NRA-Specific Training Catalogue** in the left navigation.
- Find the training — each row shows Name, mode, and user satisfaction.
- Click the star rating in the User Satisfaction column.
- Read the listed comments and ratings.
...
**Goal:** Verify completions and view a member's learning record.

**Navigation:** Left Navigation → Users

- Click **Users** in the left navigation.
- Click a team member to view their learning record: trainings completed, dates, and competencies achieved.
