...
**Goal:** Keep your NRA's user list matching your real-world team.

**Navigation:** Left Navigation → Users

!!! warning "Deleting a user is permanent"
    It removes their access. Confirm you have the right person first.

- Click **Users** in the left navigation.
- To add someone: click **+ Add User**, enter their full name, email, role, manager, and competency role, then click **Create User**.
- To update someone: select them from the list, edit their information or role, and save.
- To remove someone: select the user, click **Delete**, and confirm.
...
**Goal:** Define roles specific to your NRA's structure.

**Navigation:** Left Navigation → Roles

- Click **Roles** in the left navigation.
- Open an existing role to see what it allows, or click **+ Add New Role** to create one specific to your NRA.
...
**Goal:** Create a competency framework specific to your NRA.

**Navigation:** Left Navigation → Competency Framework → NRA-Specific Competency Framework

- Click **Competency Framework** in the left navigation.
- Click the **NRA-Specific Competency Framework** tab.
- Click **+ Create Framework**.
- Work through each step: General Information, Introduction, Domain, Sub-Domains, Role, Proficiency Level, organizational and role-specific competencies, and role-specific activities.
...
- Review the trainings mapped against your NRA-specific competency framework.
...
**Goal:** Create a training in your NRA catalogue.

**Navigation:** Left Navigation → NRA-Specific Training Catalogue

- Click **NRA-Specific Training Catalogue** in the left navigation.
- Click **Create Training**.
- Enter the training details (see field guide below).
...
**Goal:** Read learner feedback on your trainings.

**Navigation:** Left Navigation → NRA-Specific Training Catalogue

- Click **NRA-Specific Training Catalogue** in the left navigation.
- In the list, find the training — each row shows Name, mode, and user satisfaction.
- Click the star rating in the User Satisfaction column.
- Read the listed feedback, with each learner's comment and rating.
...
**Goal:** Clear your pending-request queue.

**Navigation:** Left Navigation → Pending Requests

- Click **Pending Requests** in the left navigation.
- Open each item to review who requested what, and why.
...
**Goal:** Verify completions and view a user's learning record.
...
**Goal:** Keep your NRA's profile current.

**Navigation:** Left Navigation → Organization Profile

- Click **Organization Profile** in the left navigation.
- Update the details: NRA name, website, contact email, country, and overview.
- Click **Save Changes**.
...
**Navigation:** Top-right avatar menu → Profile

- Open the Profile page.
- Update fields such as full name, country, language, manager, competency role, about / bio, and profile photo.
- Click **Save Changes**.

!!! success "Outcome"
    Your profile information is current and correctly reflected.
